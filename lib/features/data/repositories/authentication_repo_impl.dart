...
class AuthRepositoryImpl implements AuthenticationRepository {
  ...
  AuthRepositoryImpl({required this.datasource, required this.safeApiCall});
  @override
  ...
  Future<Either<Failure, void>> signOut() async {
    return await safeApiCall.call<void>(() => datasource.signOut());
  }

  @override
  Future<Either<Failure, String?>> getToken() async {
    return await safeApiCall.call<String?>(() => datasource.getToken());
  }
}
